const questions = [
  ...
  },
  {
    ...
    answers: (
      <ul className="space-y-2 pl-6 list-disc">
        <li>
          <strong>$20 honorarium per meetup organized</strong>, across June, July, and
          August. Meetups must be at least 7 days apart and there must be no more than
          5 meetups total (paid at the end of August!). Meetups are encouraged but not required.
        </li>
        <li>
